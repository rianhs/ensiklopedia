...
**Pengumpulan data** (bahasa Inggris: *data collection*) adalah proses menghimpun dan mencatat nilai-nilai dari suatu [variabel](variabel.md) pada unit pengamatan tertentu secara sistematis. Proses ini menghasilkan [data](data.md) yang menjadi bahan baku bagi seluruh aktivitas [statistika](statistika.md) selanjutnya. Data dikumpulkan dari sumber data dengan metode tertentu dan dengan menggunakan instrumen tertentu.

## Latar belakang

Sebelum data dapat disusun, dianalisis, atau diinterpretasikan, data itu harus ada terlebih dahulu. Kedengarannya sederhana, tetapi cara data diperoleh menentukan kualitas kesimpulan. Data yang dikumpulkan tanpa perencanaan yang matang, misalnya dari sumber yang salah, dengan instrumen yang tidak tepat, atau pada waktu yang tidak relevan, akan menghasilkan kesimpulan yang keliru meskipun analisisnya sempurna secara teknis.

Pengumpulan data merupakan tahap awal dalam alur statistika. Kualitas tahap ini menentukan kualitas seluruh proses selanjutnya.

## Karakteristik

Pengumpulan data selalu dimulai dari pertanyaan yang jelas: apa yang ingin diketahui, dan oleh karena itu, variabel apa yang perlu diukur. Tanpa kejelasan ini, pengumpulan data cenderung menghasilkan terlalu banyak informasi yang tidak relevan atau justru melewatkan variabel yang krusial.

Sebelum mengumpulkan data, langkah awal yang perlu dilakukan adalah membuat definisi operasional untuk suatu variabel. Definisi ini menetapkan apa yang diukur, bagaimana cara mengukurnya, dan dalam kondisi apa pengukuran dilakukan. 

Pengumpulan data ditentukan oleh tiga komponen utama: sumber, metode, dan instrumen. 

### Sumber

Sumber data mengacu pada entitas apa pun yang menghasilkan fakta yang dapat diamati atau diukur. Sumber-sumber ini dapat bersifat alami atau buatan. 
...
Setelah mendefinisikan sumber data, langkah berikutnya adalah menentukan unit pengamatan, yaitu individu atau objek aktual yang diukur, diamati, atau dimintai keterangan langsung untuk memperoleh data. Pengumpulan data pada unit pengamatan dapat dilakukan dengan cara sensus (mendata seluruh populasi) maupun sampel (mendata sebagian dari populasi). Ketika melakukan penarikan sampel, ada dua isu utama yang harus diputuskan, yaitu tekniknya dan besar (jumlah) sampelnya.
...
### Instrumen
Instrumen pengumpulan data, baik berupa alat ukur fisik, alat uji diagnostik, kuesioner, maupun protokol observasi, harus memenuhi dua syarat utama, yaitu valid dan reliabel.
...
Keterbatasan biaya, waktu, dan sumber daya merupakan penghalang yang umum ditemukan pada proses pengambilan data. Akibat keterbatasan ini, pihak pengumpul data terkadang mengorbankan suatu hal sehingga kualitas data menjadi tidak ideal.

Pengumpulan data juga tidak bebas nilai. Keputusan tentang variabel apa yang diukur, siapa saja yang dijadikan unit pengamatan, dan kapan pengukuran dilakukan semuanya mencerminkan prioritas dan asumsi peneliti. Variabel yang tidak diukur sejak awal tidak bisa dianalisis belakangan sehingga faktor-faktor penting yang terlewat pada tahap ini akan absen dari seluruh kesimpulan yang dihasilkan.
